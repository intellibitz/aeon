...
12. **The Swarm Mandate**: Every operation—Motions (1a), Missions (1b), Queries (1c), GEMI reasoning, and GMCP tool operations—must initialize a specialized GAWD Swarm at maximum hardware capacity. Direct serial execution of engine logic is prohibited.
